...
public class MatricConversionAssistant extends JFrame {
    ...
    public static void main(String[] args) {
    	...
    	MatricConversionAssistant mca = new MatricConversionAssistant();
    	mca.setVisible(true);
	}
    
    public MatricConversionAssistant() {
		...
		setResizable(false);
		setTitle("Matric Conversion Assistant");
